...
class ChairWeightComparator implements Comparator<Triangle3D> {
	...
	public int compare(Triangle3D trasero, Triangle3D delantero) {
		...
		if (traslape(trasero, delantero) == false) {
			System.out.println(trasero.name + " 1� NO TRASLAPE " + delantero.name);
			return 0;
		}
		// 2� Prueba:
		...
		// 3� Prueba
			...
			System.out.println(trasero.name + " 3� esta al FRENTE de " + delantero.name);
			return -1;
		}
		System.out
	...
	/**
	 * 1� Traslape, prueba del algoritmo del pintos
	 *
	 * @param a
	 * @param b
	 * @return
	...
	/**
	 * 2� Prueba Numero de puntos de tA que estan detras de tB
	 *
	 * @param tA
	 * @param tB
	 * @return
	...
	/**
	 * �ngulos entre la normal de A y los puntos de B
	 *
	 * @param tA
	 * @param tB
	 * @param negarNormal
