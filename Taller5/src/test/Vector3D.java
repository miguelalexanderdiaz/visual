...
public class Vector3D implements Serializable, Vector<Euclidean3D> {
	...
	public static final Vector3D POSITIVE_INFINITY = new Vector3D(Double.POSITIVE_INFINITY,
			Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY);

	/** A vector with all coordinates set to negative infinity. */
	public static final Vector3D NEGATIVE_INFINITY = new Vector3D(Double.NEGATIVE_INFINITY,
	 ...
	 * {@inheritDoc}
	 * <p>
	 * The implementation uses specific multiplication and addition algorithms
	 * to preserve accuracy and reduce cancellation effects. It should be very
	 * accurate even for nearly orthogonal vectors.
	 * </p>
	 *
	 * @see MathArrays#linearCombination(double, double, double, double, double,
	 *      double)
	 */
	...
	/**
	 * Compute the distance between two vectors according to the L
	 * <sub>&infin;</sub> norm.
	 * <p>
	 * Calling this method is equivalent to calling:
	 ...
	 * @param v2
	 *            second vector
	 * @return the distance between v1 and v2 according to the L
	 *         <sub>&infin;</sub> norm
	 */
